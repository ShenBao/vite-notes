...
const DEFAULTS = {
    inlineCode: 'code',
    wrapper: (props, { slots }) => vue_1.createVNode(vue_1.Fragment, {}, slots.default && slots.default())
};
const MDXCreateElement = vue_1.defineComponent({
    ...
    setup(props, { slots }) {
        const componentsRef = context_1.useMDXComponents(() => props.components);
        return () => {
            ...
            const Component = components[`${parentName}.${type}`] ||
                ...
                DEFAULTS[type] ||
                originalType;
            return vue_1.createVNode(Component, { ...etc }, slots.default && slots.default());
        };
    }
});
function mdx(type, props, children, patchFlag, dynamicProps, isBlockNode) {
    ...
    return vue_1.createVNode(component, newProps, children, patchFlag, dynamicProps, isBlockNode);
}
exports.default = mdx;
